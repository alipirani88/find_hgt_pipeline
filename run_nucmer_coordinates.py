...
# Method used for Nursing Home Project
...
if __name__ == '__main__':
    ...
    # Commenting this block temporarily. Belongs to Nursing home project
    ...
    # Run KPC project analysis
    condition_directory = parse_coord_aggregate(folder, folder_dir)

    # Combine extracted/aligned regions and their annotations
    condition_directory = folder_dir + "/All_vs_All/"
    make_sure_path_exists("%s/database" % condition_directory)
    cat_fasta_cmd = "cat %s/%s_*/*.aligned.fasta >> %s/database/Extracted_aligned_region.fasta" % (condition_directory, file_name.replace('.fasta', ''), condition_directory)
    cat_fasta_meta_cmd = "cat %s/%s_*/*.aligned.fasta_meta.tsv >> %s/database/Extracted_aligned_region.fasta_meta.tsv" % (
    condition_directory, file_name.replace('.fasta', ''), condition_directory)
    os.system(cat_fasta_cmd)
    os.system(cat_fasta_meta_cmd)
